 ...
 */
let ymap_url = "https://api-maps.yandex.ru/2.1/?apikey=62e46ec4-c446-4e02-b257-50b67d420173&lang=ru_RU";
let city_from_ymap = function () {
...
/**
 * get city from GeoPlugin
 */
let geoplugin_url = "http://www.geoplugin.net/javascript.gp";
function city_from_geoplugin() {
    let city = document.getElementById("location").innerHTML; // !!! get var from php var from @layout-header.latte from Basepresenter
    if (city == 'Местоположение') {
        const x = document.getElementById("location");
        city = geoplugin_city();
...
//loadScript(ymap_url, city_from_ymap);

loadScript(geoplugin_url, city_from_geoplugin);
})();
